      ...
      <div class="mb-3 xl:w-96">
        <div class="input-group relative flex flex-wrap items-stretch w-full mb-4 rounded">
          ...
          <input type="search" 
            ...
            placeholder="몸으로 말해요 게임 순위를 알아보세요" 
            aria-label="Search" 
            aria-describedby="button-addon2"
            @keyup.enter="searchStart({searchNickname : searchNickname, modeSequence : 3})">
          <!-- 검색버튼 -->
          <span class="input-group-text flex items-center px-3 py-1.5 text-base font-normal text-gray-700 text-center whitespace-nowrap rounded" 
            id="basic-addon2"
            @click="searchStart({searchNickname : searchNickname, modeSequence : 3})">
