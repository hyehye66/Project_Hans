<template>
  <div>
    ...
    <div class="nickname-rank" v-if="searchFinish===true && modeSequence === this.modeSequence">
...
export default {
  ...
  methods: {
    searchStart () {
      axios ( {
          url: `/api/rankings/search?nickname=${this.searchNickname}&id=${this.modeSequence}`,
