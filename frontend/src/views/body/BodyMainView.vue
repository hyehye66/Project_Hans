...
<nav-bar />
  <div class="container">
    ...
    <p id="chat-main-title" class="d-flex justify-content-space-around py-2 px-4 mt-8">몸으로 말해요&nbsp;
      <svg @click="isHowtobodyOpen" xmlns="http://www.w3.org/2000/svg" width="43" height="43" fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16" style="cursor: pointer">
    ...
    <div class="mb-3 xl:w-96">
      <div class="input-group relative flex flex-wrap items-stretch w-full mb-4">
        ...
        focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Search" 
        aria-label="Search" aria-describedby="button-addon2"      
        v-model="input"
        @keyup.enter="searchRoom({input : input, searchSelected : searchSelected, mode : 'body-game'})">

        <button class="btn inline-block px-6 py-2.5 search-btn text-white 
        ...
        transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2"
         @click="searchRoom({input : input, searchSelected : searchSelected, mode : 'body-game'})">
