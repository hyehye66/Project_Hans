...
<nav-bar />
  <div class="container">
    ...
    <p id="chat-main-title" class="d-flex justify-content-space-around py-2 px-4 mt-8">낱말퀴즈&nbsp;
      <svg @click="isHowtowordOpen" xmlns="http://www.w3.org/2000/svg" width="43" height="43" fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16" style="cursor: pointer">
  ...
  <div class="mb-3 xl:w-96">
    <div class="input-group relative flex flex-wrap items-stretch w-full mb-4">
      ...
      v-model="input"
      @keyup.enter="searchRoom({input : input, searchSelected : searchSelected, mode : 'word-game'})">
      ...
      @click="searchRoom({input : input, searchSelected : searchSelected ,mode : 'word-game'})">
