    ...
    <div id="session" v-if="session">
			<div id="session-header">
				...
				<div class="back-title">
					...
					<!-- 방 제목 issue! -->
					<!-- {{ WordsRoomCreateModal.roomTitle }} -->
				</div>
      ...
      <div id="session-body-left" class="col-md-7">
        <!-- 메인화면 -->
...
import WordsRoomUpdateModal from '@/views/modal/components/WordsRoomUpdateModal.vue';
// import {  } from '@heroicons/vue/solid';
import { VideoCameraIcon, MicrophoneIcon, PaperAirplaneIcon, CogIcon, LogoutIcon } from '@heroicons/vue/outline';
